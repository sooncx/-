        ...
        >
          <div class="VehSelect__tab-pane-content">
            <div
              ...
              VehItem_online: item.state === 0,
              VehItem_stop: item.state === 3 || item.state === 4,
              VehItem_valid: item.state !== 2,
              VehItem_disabled: item.state === 2,
            ...
            >
              ...
              <div class="VehItem__plate">{{item.plate}}</div>
              <div
...
export default {
  ...
  methods: {
    ...
    handleOnVehItemClick(veh, flag) {
      console.log("click-detail-start vehIndices");
      console.log(this.vehIndices);
      if (veh.state === 2) {
        this.$msg({
          showClose: true,
          message: "无效车辆",
      ...
      if (flag) {
        ...
        vehInfo = veh;
        console.log("click-detail vehIndices");
        console.log(this.vehIndices);
      } else {
        //取消车辆
        ...
        console.log("click-detail-after vehIndices");
        console.log(this.vehIndices);
      }
    ...
    async updateVehGroup(gids) {
      ...
      try {
        ...
        const alldata = gids.length
          ...
          : [];
        const nowData = alldata.vehicleMonitoringVos;
        //合并新旧车辆
        const data = [...curData, ...(nowData || [])];
        this.tabItems[0].total = alldata.tatol;
        this.tabItems[1].total = alldata.online;
        this.tabItems[2].total = alldata.line;
        this.tabItems[3].total = alldata.outStandard;
    ...
    async hanldeNodeClick({ organizationId }, node) {
      console.log("click-treenode vehIndices");
      console.log(this.vehIndices);
      this.currentPage = 1;
      //加载当前车组内车辆信息
