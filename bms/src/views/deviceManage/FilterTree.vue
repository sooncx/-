<template>
  <div class="filter-tree">
    ...
    <div class="filter-tree__content">
      ...
      >
        <span class="filter-tree__node" slot-scope="{ node, data }">
...
export default {
  ...
  data() {
    return {
      ...
      iconList: [
        ...
        { icon: "icon-Additionalcar", title: "添加组织", value: "addToGroup" }
      ]
    };
  },
  ...
  methods: {
    ...
    filterNode(value, data) {
      ...
      return data.organizationName.toLocaleLowerCase().indexOf(value.toLocaleLowerCase()) !== -1;
    },
    handleGroupClick(type, data) {
      ...
      switch (type) {
        ...
        case "onEditGroup":
          ...
          break;
        case "addToGroup":
          this.$emit("onHandleVeh", "add", data);
          break;
      }
    }
  }
